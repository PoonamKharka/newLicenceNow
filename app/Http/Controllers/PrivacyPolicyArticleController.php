...
class PrivacyPolicyArticleController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $instructorTermsAndCondition = PrivacyPolicyArticle::all();
            return datatables()
    ...
    public function store(Request $request)
    {
        ...
        $instructorTermsAndCondition = PrivacyPolicyArticle::updateOrCreate(
            ['id' => $request->input('id')],
            $validatedData
        );
    ...
    public function edit($id)
    {
        ...
        $instructorTermsAndCondition = PrivacyPolicyArticle::findOrFail($instructorTermsAndConditionId);
    ...
    {
        $instructorTermsAndCondition = PrivacyPolicyArticle::find($id);

                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header ">
                            <h3 class="card-title">
                                <a href="{{ route('users.create') }}" class="btn btn-light btn-sm btn-success">Add
                                    Instructors</a>
                            </h3>
                        </div><!-- /.card-header -->
                        <div class="card-body">
    ...
    <script>
            ...
            function updateInstructorStatus(instructorId, status) {
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        toastr.error('Failed to update status!' + error, 'Error', {
                            timeOut: 5000
                        });
                    }
                });
        ...
        $(document).on('click', '.view-btn', function() {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    toastr.error('Unable to load instructor details. Please try again later.',
                        'Error', {
                            timeOut: 5000
                        });
                }

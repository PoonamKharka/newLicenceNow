                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-success"><a
                                    href="{{ route('learner-terms-and-condition.create') }}"
                                    style="text-decoration: none; color:aliceblue">Add Learner Terms and
                                    Conditions</a></button>
                            <br><br>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                if (confirm('Are you sure you want to delete this learner terms and conditions?')) {
                    ...
                    var form = $('<form>', {
                        action: "{{ route('learner-terms-and-condition.destroy', '') }}" + '/' +
                            testpackageId,
                        method: 'POST'
                    });

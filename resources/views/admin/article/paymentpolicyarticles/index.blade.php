                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-success"><a
                                    href="{{ route('payment-policy-articles.create') }}"
                                    style="text-decoration: none; color:aliceblue">Add payment policy</a></button>
                            <br><br>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                if (confirm('Are you sure you want to delete this payment policy?')) {
                    ...
                    var form = $('<form>', {
                        action: "{{ route('payment-policy-articles.destroy', '') }}" + '/' +
                            testpackageId,
                        method: 'POST'
                    });

            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title">Latest Instructors</h3>
                        ...
                        <div class="card-body p-0">
                            <ul class="users-list clearfix">
                                @foreach ($instructors as $instructor)
                                    <li>
                                        <img src="{{ $instructor->profile_image ?? ($instructor->profileDetails->profile_picture ?? asset('adminlte/dist/img/user8-128x128.jpg')) }}"
                                            alt="User Image">
                                        <a class="users-list-name"
                                            href="{{ route('instructors.show', encrypt($instructor->id)) }}">{{ $instructor->first_name }}
                                            {{ $instructor->last_name }}</a>
                                        <span class="users-list-date"> {{ $instructor->created_at }}</span>
                                    </li>
                                @endforeach
                        ...
                        <div class="card-footer text-center">
                            <a href="{{ route('instructors.index') }}">View All Users</a>
                        </div>
                        <!-- /.card-footer -->
                    </div>
                    <!--/.card -->
